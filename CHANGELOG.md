...
- https://github.com/Buildvana/Buildvana.Sdk/pull/161 - Setting the `UseVersionFile` property to `false` disables parsing the version file and assigning related properties.
...
- https://github.com/Buildvana/Buildvana.Sdk/pull/158 - **BREAKING CHANGE:** The ThisAssemblyClass module has been removed. The recommended workaround is to use the [`ThisAssembly`](https://nuget.org/packages/ThisAssembly) package.
- https://github.com/Buildvana/Buildvana.Sdk/pull/163 - **BREAKING CHANGE:** Buildvana SDK does not use or recognize a version file any longer. This is in preparation to next alpha version, that will introduce a more permanent solution to "versioning hell".
