...
namespace Buildvana.Sdk.Internal
{
    ...
    internal static class ExceptionExtensions
    {
        ...
        public static bool IsIORelatedException(this Exception @this)
            ...
            || (@this is ArgumentException && !(@this is ArgumentNullException))
        ...
        [PublicAPI]
        public static bool IsFatalException([NotNull] this Exception @this)
        ...
        [PublicAPI]
        public static bool IsCriticalException([NotNull] this Exception @this)
        ...
        /// <seealso cref="IsCriticalException"/>
        [PublicAPI]
        public static bool IsSecurityOrCriticalException([NotNull] this Exception @this)
        ...
        /// <summary>
        /// Rethrows an exception preserving its original stack trace.
        /// </summary>
        /// <param name="this">The <see cref="Exception"/> on which this method is called.</param>
        [PublicAPI]
        [ContractAnnotation("=> halt")]
        public static void RethrowPreservingStackTrace([NotNull] this Exception @this)
            => ExceptionDispatchInfo.Capture(@this).Throw();

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        private static bool IsFatalExceptionCore([NotNull] this Exception @this)
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        private static bool IsCriticalExceptionCore([NotNull] this Exception @this)
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        private static bool IsSecurityOrCriticalExceptionCore([NotNull] this Exception @this)
